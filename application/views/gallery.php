...
<html lang="en">
<head>
<title>Shakti Tours Travels | Gallery</title>
<meta charset="utf-8">
...
<div class="img"><img src="<?php echo base_url(); ?>assets/pic/gallry.png" alt="<?php echo SHAKTI_IMAGE_TAG; ?>"></div>
...
<div class="breadcrumbs1_inner"><a href="<?php echo base_url(); ?>">Home Page</a>&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;Gallery</div>	
</div>
</div>
</div>
    ...
    <li class="span3 isotope-element isotope-filter1">
		<div class="thumb-isotope">
			<div class="thumbnail clearfix">
				<a href="<?php echo base_url().$r->image; ?>">
					<figure>
						<img src="<?php echo base_url().$r->thumbimage; ?>" alt="<?php echo SHAKTI_IMAGE_TAG; ?>"><em></em>
					</figure>
					<div class="caption">
						<div class="txt1"><?php echo $r->city; ?></div>							
					</div>
				</a>				
			</div>
		</div>
...
<h1>No Any Item Added Back Soon...</h1>

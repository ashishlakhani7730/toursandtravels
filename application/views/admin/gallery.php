				...
				<div id="failMessage" class="alert alert-danger alert-dismissable">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form role="form" action="<?php echo base_url()."admin/Gallery/addGallery" ?>" method="post" enctype="multipart/form-data" >
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
								...
								<?php if(!empty($records)){ foreach($records as $r) { 
                                    ...
                                    echo "<td>".$r->city."</td>";                                  
								    echo "<td><a href=".base_url()."admin/Gallery/delGallery/".$r->gid."/".$r->image." name='delete' class='btn btn-danger'>Delete</a></td>";
                                    echo "</tr>";
